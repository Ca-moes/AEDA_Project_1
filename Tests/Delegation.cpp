                ...
                for (int j = 0; j < sport->getCompetitions().size(); ++j) {
                    ...
                    if (sport->getCompetitions().at(j).getTrials().size()!= 0){
                        for (int k = 0; k < sport->getCompetitions().at(j).getTrials().size() ; ++k) {
                            ...
                            myfile << sport->getCompetitions().at(j).getTrials().at(k).getParticipants().size() << endl;
                            myfile << sport->getCompetitions().at(j).getTrials().at(k).getDate() << endl;
                            for (int l = 0; l < sport->getCompetitions().at(j).getTrials().at(k).getParticipants().size(); ++l) {
                                myfile << sport->getCompetitions().at(j).getTrials().at(k).getParticipants().at(l);
                                if (l != sport->getCompetitions().at(j).getTrials().at(k).getParticipants().size()-1)    // se não for ultimo participante mete "v"
                                    myfile << ",";
                                else        //ultimo participante mete novalinha
                                    myfile << "\n";
                            }
                            myfile << sport->getCompetitions().at(j).getTrials().at(k).getWinner() << endl;
                            if (k == sport->getCompetitions().at(j).getTrials().size()-1)
                                myfile << "\n";
                        }
                    }
                    else{
                ...
                for (int j = 0; j < sport->getCompetitions().size(); ++j) {
                    ...
                    if (sport->getCompetitions().at(j).getTrials().size()!= 0){
                        for (int k = 0; k < sport->getCompetitions().at(j).getTrials().size() ; ++k) {
                            ...
                            for (int l = 0; l < sport->getCompetitions().at(j).getTrials().at(k).getParticipants().size(); ++l) {
                                myfile << sport->getCompetitions().at(j).getTrials().at(k).getParticipants().at(l);
                                if (l != sport->getCompetitions().at(j).getTrials().at(k).getParticipants().size()-1)
                                    myfile << ",";
                                else{}
                                    //myfile << "\n";
                            }
